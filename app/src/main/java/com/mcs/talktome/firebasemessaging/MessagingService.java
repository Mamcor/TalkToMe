package com.mcs.talktome.firebasemessaging;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        builder.setContentText(remoteMessage.getData().get(Constants.KEY_USER_MESSAGE));
        builder.setStyle(new NotificationCompat.BigTextStyle().bigText(
                remoteMessage.getData().get(Constants.KEY_USER_MESSAGE)
        ));
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            String channelDescription = "Notification de message chat";
